...
from churn_aiml.datetime_ml.iso_converters import (
    ISOWeekDateConverter,
    WeekMidpointConverter
)
...
logger = get_logger()
logger.info("Starting:\n01_FINAL_DOCUWARE_CHURN_MODEL_VERSION_FINAL_UAT_2_CATBOOST_Replica")
# %%
# Outputs
...
convert_yyyywk_to_date = ISOWeekDateConverter(cfg).convert_yyyywk_to_date
# %%
# def convert_yyyywk_to_actual_mid_date(yyyywk):
convert_yyyywk_to_actual_mid_date= WeekMidpointConverter(cfg).convert_yyyywk_to_actual_mid_date
# %%
# def get_days_diff(yyyywk, last_yyyywk):
get_days_diff = WeekMidpointConverter(cfg).get_days_diff
day_start, dat_end = 202318, 202401
print(f"test:\nday_start, dat_end, days_diff:\n{day_start},    {dat_end},  {get_days_diff(day_start, dat_end)}")
# %% [markdown]
# # UTILITY Function 3
# %%
# def convert_date_to_yyyywk(d):
convert_date_to_yyyywk = WeekMidpointConverter(cfg).convert_date_to_yyyywk
# %% [markdown]
# # UTILITY Function 4
# %%
...
# %%
print("usage_latest:")
print(f"columns: {len(list(usage_latest.columns))}")
print("\n".join(list(usage_latest.columns)))
# %%
usage_latest.info()
# %%
...
# %%
# Active -
# If contract start date <= 2022-12-31 for active then we need to add weekly usage numbers
# (average of last 10 for numerical)
